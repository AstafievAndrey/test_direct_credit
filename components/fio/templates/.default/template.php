...
fioApp.controller('FioListController', function FioListController($http,$scope,$timeout) {
    ...
    $scope.check = function(value){
        if( (value.PROPERTY.SURNAME === undefined || value.PROPERTY.SURNAME.search(/^[А-Яа-я]+$/) === -1) || 
            (value.PROPERTY.FIRSTNAME === undefined || value.PROPERTY.FIRSTNAME.search(/^[А-Яа-я]+$/) === -1) ||
            (value.PROPERTY.LASTNAME === undefined || value.PROPERTY.LASTNAME.search(/^[А-Яа-я]+$/) === -1)){
            return false;
        }
        return true;
    }
